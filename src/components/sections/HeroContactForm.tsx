  ...
  return (
    <div className="relative rounded-[var(--radius-asp-xl)] p-[2px] bg-asp-gradient-cta shadow-asp-xl">
      <div className="bg-white rounded-[calc(var(--radius-asp-xl)-2px)] p-6 md:p-8">
        <h3 className="font-bold text-xl text-asp-blue mb-1">Get Your Free Strategy Session</h3>
        <p className="text-gray-500 text-sm mb-6">No obligation — just actionable insights for your business.</p>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-[var(--radius-asp-md)] bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 focus:border-asp-blue focus:ring-2 focus:ring-asp-blue/20 transition-all outline-none text-sm"
            />
            <input
              type="email"
              name="email"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <select
              name="service"
              className="w-full px-4 py-3 rounded-[var(--radius-asp-md)] bg-gray-50 border border-gray-200 text-gray-500 focus:border-asp-blue focus:ring-2 focus:ring-asp-blue/20 transition-all outline-none text-sm"
            >
          ...
          <button
            ...
            className="w-full bg-asp-blue text-white font-bold py-3.5 px-6 rounded-[var(--radius-asp-md)] hover:bg-asp-blue-dark transition-all duration-150 text-sm disabled:opacity-50"
          >
