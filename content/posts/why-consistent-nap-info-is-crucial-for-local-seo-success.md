...
schema:
  ...
  faqItems:
    - question: "What does NAP stand for in local SEO?"
      answer: "Name, Address, and Phone number. It refers to the three core pieces of business identity data that need to match across every directory, citation source, and listing where your business appears online."
    - question: "How much does NAP inconsistency actually hurt rankings?"
      answer: "Enough to be noticeable. Inconsistent NAP is one of the most commonly cited local ranking factors across industry research, and in our experience cleaning up NAP alone can move a business several positions in the map pack within 60 to 90 days."
    - question: "Do I need to include my suite number everywhere?"
      answer: "Yes — and it needs to be formatted the same way on every listing. 'Suite 200' and 'Ste. 200' and '#200' are treated as different addresses by some aggregators. Pick one format and enforce it everywhere."
    - question: "What if my business moves locations?"
      answer: "You have to update every citation, not just Google Business Profile. A move usually temporarily tanks local rankings — the recovery depends on how quickly and thoroughly the citation cleanup happens."
    - question: "How many citations does a home service business need?"
      answer: "Quality over quantity. Fifty high-authority, industry-relevant citations outperform two hundred generic ones. Focus on major aggregators, industry-specific directories, and local business registries first."
    - question: "Can I manage NAP myself, or do I need a tool?"
      answer: "For a single location, it's doable manually if you're disciplined. For multi-location businesses, a citation management platform pays for itself fast. Either way, the ongoing monitoring is what most operators get wrong."
status: "published"
...
One more wrinkle: AI answer engines like Google's AI Overview, ChatGPT, and Perplexity pull from the same citation graph that Google's local algorithm uses. An inconsistent entity profile doesn't just hurt traditional rankings anymore — it also means AI systems can't confidently cite you in their generated answers. [AEO for home service businesses](/blog/ai-optimization-aeo-home-service-businesses-2025) goes deeper on this, but the short version is: NAP consistency is now a dual-purpose fix. Traditional SEO benefit, plus AI citation benefit.
...
Ready to audit your citation footprint? [Get in touch with ASP](/contact) or [run the Growth Diagnostic](/diagnostic) to see how your local SEO foundation looks today.
