---
title: "When a Home Service Business Needs a Fractional CFO"
slug: "when-to-hire-fractional-cfo-home-service"
...
schema:
  type: "Article"
  faqItems:
    - question: "At what revenue should a home service business hire a fractional CFO?"
      answer: "The honest answer is somewhere between $3M and $5M for most operators, though we've seen earlier hires make sense when the business is growing fast or preparing for acquisition. Below $3M a good bookkeeper plus a monthly review with an outside CPA typically covers you. Once you cross $3M — especially if you're running multiple trucks, multiple service lines, or multiple locations — the questions your bookkeeper can't answer start costing you real money. That's the trigger, not the round revenue number."
    - question: "What does a fractional CFO actually do day to day?"
      answer: "A fractional CFO owns the financial strategy and the reporting layer that sits on top of your bookkeeping. In practice, that's building a rolling 13-week cash flow, producing monthly management reports that explain the business (not just the ledger), modeling pricing and crew changes before you make them, sitting in on leadership meetings, and coordinating with your bookkeeper, CPA, and bank. It's not data entry. It's the financial translation layer between the books and the decisions you're making as an operator."
    - question: "What is the difference between a fractional CFO, a controller, and a bookkeeper?"
      answer: "A bookkeeper records what already happened — bills, payments, payroll, reconciliations. A controller owns the accuracy and integrity of that ledger, closes the books monthly, and manages the bookkeeper. A fractional CFO uses the output of the controller and bookkeeper to drive forward-looking decisions — cash forecasting, pricing models, capital allocation, exit prep. Most operators under $5M don't have a controller — their CPA fills that seat part-time. The CFO is the layer above both."
    - question: "How much does a fractional CFO cost for a contractor?"
      answer: "Typical retainers run $2,500 to $8,000 per month depending on the scope — hours per month, number of entities, reporting cadence, and whether the CFO is also leading specific projects like a bank refinance or M&A prep. Project-based engagements (exit readiness, debt restructuring, a one-time pricing overhaul) can be quoted as fixed fees. Anything under $2K a month is usually a senior bookkeeper with a nicer title, not a true CFO."
    - question: "Can a fractional CFO help me prepare to sell my business?"
      answer: "Yes, and this is one of the highest-ROI reasons to hire one. Buyers and lenders read financial statements the way a plumber reads a manifold — they spot sloppy workmanship fast. A fractional CFO cleans up the chart of accounts, normalizes the add-backs, builds a defensible EBITDA calculation, and produces the data room package. Operators who bring a CFO in 18 to 24 months before a sale routinely close at meaningfully better multiples than operators who hand a buyer a QuickBooks file."
    - question: "What financial reports should I expect from a fractional CFO?"
      answer: "At minimum, a monthly management report package — P&L with variance commentary, balance sheet, cash flow statement, and a KPI dashboard specific to home service (revenue per truck, gross margin by service line, close rate, average ticket, AR aging). Plus a rolling 13-week cash forecast updated weekly. Plus a quarterly strategic review. If your fractional CFO is handing you a raw QuickBooks export with no narrative, you're getting bookkeeping output, not CFO output."
    - question: "Is a fractional CFO worth it under $5M in revenue?"
      answer: "Conditionally, yes. If you're at $2M and growing 40% a year, or running multiple service lines, or preparing for a capital raise or acquisition, it's worth it. If you're at $2M, steady, and your bookkeeper plus CPA are giving you clean books and you're not making major capital decisions, you can probably wait. The trigger is complexity, not revenue alone. A fast-growing $2M operator often needs CFO help more than a steady $4M one."
status: "published"
...
**Under $1M.** You don't need a fractional CFO. You need a good bookkeeper and a CPA who'll take a call when you need them. Spend the money on [lead generation and your growth system](/growth-system) instead.
...
1. **A rolling 13-week cash flow forecast**, updated weekly, that you and your leadership team actually look at.
2. **A redesigned monthly management report** — P&L with variance commentary, balance sheet, cash flow, KPI dashboard — delivered in under five business days after month-end close.
3. **A financial model of the business** with the two or three scenarios you're most likely to run in the next 12 months already built (adding a crew, opening a location, taking on debt, etc.).
4. **A written 12-month financial priorities document** — the three to five initiatives the finance function will drive, with owners and timelines.
...
No. They're different skill sets and different seats. You can have both in a fractional model — that's actually a common structure for $3M–$10M operators — but they should be different humans. At ASP we run [the Fractional C-Suite](/fractional) as an integrated team so the finance and marketing leadership talk to each other without each client having to broker it.

### What accounting software should I be on before hiring a CFO?

At minimum, clean QuickBooks Online tied to a bank feed with a sensible chart of accounts. For home service specifically, a job-level system like Housecall Pro that ties revenue to customers and jobs. Operators above $5M often migrate to something heavier — Sage Intacct, NetSuite — but don't do that migration before you have a CFO to own the project. [Wikipedia's overview of the CFO role](https://en.wikipedia.org/wiki/Chief_financial_officer) has a reasonable public-facing summary of the function if you want the academic framing.
...
If you want to figure out whether you're actually at the tier where a fractional CFO pays for itself, [walk through our Fractional C-Suite practice](/fractional) or [run the Growth Diagnostic](/diagnostic) and we'll tell you honestly — including whether the answer is "not yet." No decks, no pressure. Just a working session on where your finance function is and where it needs to be.
